...
<head>
    ...
    <!-- === CSS SWIPER (sempre antes do seu CSS) === -->
...
<header class="site__header">
    <div class="container header__inner">
        ...
        <nav class="nav" aria-label="Principal">
            ...
            <a class="btn btn-covil" href="<?php echo $config['hotmart_link']; ?>?utm_source=<?php echo urlencode($_GET['utm_source'] ?? 'organic'); ?>">Entrar para o Covil</a>
        </nav>
    </div>
</header>
